import type { LooseJsonObject } from './json.ts';
...
export interface EvalCase {
  ...
  expected: LooseJsonObject;
  scoring: LooseJsonObject;
  passCriteria: LooseJsonObject;
...
export interface EvalCaseResult {
  ...
  judgeResult?: LooseJsonObject;
  humanReview?: LooseJsonObject;
  finalOutput?: string;
  error?: string;
}
...
export interface EvalRun {
  ...
  config?: { contextStrategy?: string; toolPolicy?: string };
