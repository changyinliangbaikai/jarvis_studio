...
export function ConversationPage() {
  ...
  return <section>
    <PageHeader eyebrow={t('pages.conversation.string_1')} title={t('pages.conversation.string_2')} description={t('pages.conversation.string_3')}
    ...
    {turns.length === 0 ? <Empty>{t('pages.conversation.string_4')}</Empty> :
      <div className="conversation">{turns.map((turn) => <article key={turn.id} className="turn-card">
        ...
        <div className="turn-body">
          ...
          <div className="message user-message"><UserRound size={16} /><div><b>{t('pages.conversation.string_5')}</b><p>{turn.userMessage}</p></div></div>
